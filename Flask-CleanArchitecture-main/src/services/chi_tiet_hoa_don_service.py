...
class ChiTietHoaDonService:
    ...
    def create(self, id_hd, vat, soluong, id_monan):
        return self.repo.add(ChiTietHoaDon(None, id_hd, vat, soluong, id_monan))
    ...
    def update(self, id_cthd, id_hd, vat, soluong, id_monan):
        return self.repo.update(ChiTietHoaDon(id_cthd, id_hd, vat, soluong, id_monan))
