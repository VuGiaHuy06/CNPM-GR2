...
class HoaDonService:
    ...
    def update(self, id_hd, id_dh, id_voucher, id_banan, ngayinhoadon, tongtien):
        return self.repo.update(HoaDon(id_hd, id_dh, id_voucher, id_banan, ngayinhoadon, tongtien))
